...
conda install -c conda-forge pypdf bs4 tiktoken transformers langdetect langchain-experimental langchain-huggingface langchain-ollama  
conda install -c conda-forge numpy==1.26.4  
conda install -c conda-forge faiss-cpu openpyxl  
pip install krag kiwipiepy rank_bm25 jq  
...
conda install -c conda-forge langchain-anthropic langchain-google-genai langchain-groq google-genai groq  
