...
.jupyter 폴더가 보이지 않으면 까만 화면에서 jupyter nbclassic --generate-config를 실행한다.
...
② 04_벡터저장소_벡터검색기_검색성능평가.ipynb - 벡터 저장소에 데이터 입력, 수정, 삭제, 조회 시작  
...
② 01_LangChain의_주요_RAG_컴포넌트.ipynb - RAG 주요 컴포넌트 시작  
&nbsp;&nbsp;&nbsp;&nbsp;■ embeddings1.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ embeddings2.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ vectorStore1.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ vectorStore2.png
...
# 2026년 8월 26일 - 55일차
① 03_국민청원데이터_시각화_분류.ipynb - 국민 청원 데이터 시각화 분류 - 완료  
&nbsp;&nbsp;&nbsp;&nbsp;■ 국민청원텍스트지도학습.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ 학습유형도식화.png

# 2026년 8월 25일 - 54일차
① 02_연합뉴스_타이틀_주제분류.ipynb - TF-IDF를 사용해서 연합뉴스 타이틀 주제 분류 - 완료  
② 03_국민청원데이터_시각화_분류.ipynb - 국민 청원 데이터 시각화 분류 - 시작  
&nbsp;&nbsp;&nbsp;&nbsp;■ 국민 청원 데이터는 공유 폴더의 petitions.zip 파일 다운로드  
&nbsp;&nbsp;&nbsp;&nbsp;■ k폴드.png
...
## 자연어 처리
② 01_단어가방_모형과_TF_IDF.ipynb - 단어 가방 모형(CountVectorizer)과 TF-IDF 사용하기 - 시작  
&nbsp;&nbsp;&nbsp;&nbsp;■ CountVectorizer_실행하기.md  
&nbsp;&nbsp;&nbsp;&nbsp;■ n_gram.png

# 2026년 8월 14일 - 49일차
① 26_행복지수_데이터분석.ipynb - 행복지수 데이터 분석 - 완료  
② 27_노쇼환자_데이터분석.ipynb - 병원 노쇼환자 데이터 분석  
&nbsp;&nbsp;&nbsp;&nbsp;■ 병원노쇼.zip  
③ 28_주식시세_데이터분석.ipynb - 주식시장, 종복 정보 읽어오기 - 시작    
&nbsp;&nbsp;&nbsp;&nbsp;■ 세계시장.md

# 2026년 8월 13일 - 48일차
① 24_카드전표분석.ipynb - 카드 소비 데이터 분석  
② 25_핫플레이스_인구분석.ipynb - 행정동별 생활인구 분석  
③ 26_행복지수_데이터분석.ipynb - 행복지수 데이터 분석 - 시작  
&nbsp;&nbsp;&nbsp;&nbsp;■ 행복지수 분석.zip  
&nbsp;&nbsp;&nbsp;&nbsp;■ 행복지수_데이터분석.md
...
② 50_차원축소_커널주성분분석(KPCA).ipynb - 커널 주성분 분석  
③ 51_차원축소_선형판별분석(LDA).ipynb - 선형 판별 분석  
④ 52_차원축소_지역적선형임베딩(LLE).ipynb - 지역적 선형 임베딩  
⑤ 53_차원축소_비음수행렬분해.ipynb - 비음수 행렬 분해  

# 2026년 8월 5일 - 42일차
① 40_로지스틱회귀.ipynb - 로지스틱 회귀 완료  
② 41_나이브베이즈.ipynb - 가우시안 나이브 베이즈  
...
⑨ 48_앙상블_스태킹.ipynb - 앙상블(스태킹)


# 2026년 8월 4일 - 41일차
① 37_모델평가.ipynb - 모델 평가하기 완료  
② 38_k최근접이웃.ipynb - 최근접 이웃  
③ 39_선형회귀.ipynb - 선형회귀, 릿지, 라쏘, 엘라스틱넷  
④ 40_로지스틱회귀.ipynb - 로지스틱 회귀 시작
...
&nbsp;&nbsp;&nbsp;&nbsp;■ RNN.png  
③ 30_순환신경망(Recurrent_Neural_Network, RNN)_Word_Class.ipynb - RNN 단어 분류  
④ 31_장단기기억모델(Long_Short_Term_Memory, LSTM)_Basic.ipynb - LSTM 기초  
&nbsp;&nbsp;&nbsp;&nbsp;■ LSTM1.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ LSTM2.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ LSTM3.png  
...
② 28_합성곱신경망(Convolutional_Neural_Network, CNN)_MNIST_손글씨.ipynb - CNN 손글씨 데이터 - 시작  
&nbsp;&nbsp;&nbsp;&nbsp;■ CNN1.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ CNN2.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ CNN3.png  
&nbsp;&nbsp;&nbsp;&nbsp;■ CNN4.png  
...
③ 09_tuple.ipynb - 튜플 사용법  
④ 10_dictionary.ipynb - 딕서너리 사용법  
⑤ 11_set.ipynb - set 사용법  
⑥ 12_while.ipynb - 제어문(while) 사용법  
⑦ 13_lottoNumber_list.ipynb - 리스트를 사용한 로또 1등 번호 생성 알고리즘
...
# 2026년 6월 9일 - 2일차
① 01_print.ipynb - print() 함수 사용법 완료  
② 02_input.ipynb - input() 함수 사용법  
③ 03_string.ipynb - 문자열 사용법  
④ 04_stringMethod.ipynb - 문자열 관련 메소드 사용법  
⑤ 05_if.ipynb - 제어문(if) 사용법 시작  
